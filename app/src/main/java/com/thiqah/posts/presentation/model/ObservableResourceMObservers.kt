...
class ObservableResourceMObservers<T> : SingleLiveEventMObservers<T>() {

    val error: SingleLiveEventMObservers<ThiqahException> = ErrorLiveData()
    val loading: SingleLiveEventMObservers<Boolean> =
        SingleLiveEventMObservers()
    ...
    class ErrorLiveData : SingleLiveEventMObservers<ThiqahException>() {
